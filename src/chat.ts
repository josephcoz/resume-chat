...
const OUTPUT_REMINDER = [
  ...
  '3. **Name the gaps, including in the opening read.** If something is not covered, say "Not covered"',
  '   plainly and say what he uses instead. The one or two sentence headline must mention the real gaps,',
  '   not only the strengths — an assessment with no gaps reads as marketing and gets discounted entirely.',
  '   When a posting has both responsibilities and a qualifications list, the remaining-items list covers',
  '   both, so named tools he has not used still surface.',
